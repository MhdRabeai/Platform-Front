...
const Contact = () => {
  ...
  return (
    <>
      <section className="relative z-10 overflow-hidden  min-g-screen">
              ...
              <div className="lg:col-span-4 flex  h-full">
                <div className="mb-12 max-w-[570px] lg:mb-0 flex flex-col justify-center">
                  <div className="w-full">
                    <span className=" block text-lg font-semibold text-primary text-[#4F9451]">
                      Contact Us
                    </span>
                    ...
                    <p className="mb-5 text-base text-gray-600 ">
                      ...
                      email, or by filling out our contact form.
                    </p>
                  </div>

                  <div className="mb-4 flex w-full max-w-[370px] items-center gap-3">
                ...
                <div className="relative rounded-lg bg-white  shadow-lg  px-8 py-10">
                  <form onSubmit={handleFeedBack}>
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full rounded-lg border border-primary bg-[#4f9451] py-2 text-white transition hover:bg-opacity-90 text-base"
                      >
                        Send Message
                      </button>
                    </div>
